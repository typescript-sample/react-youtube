...
export const UsersPage = () => {
  ...
  const p = { getFilter }
  const { state, resource, component, updateState, search, sort, clearQ, toggleFilter, changeView, pageChanged, pageSizeChanged } = useSearch<
    User,
    UserFilter,
    UserSearch
  >(refForm, initialState, getUserService(), inputSearch(), p)
